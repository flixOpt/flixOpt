...
class TestModelingTypes(BaseTest):
    ...
    def calculate(self, modeling_type: Literal["full", "segmented", "aggregated"]):
        ...
        aStromEinspeisung, aStromTarif = cSink('Einspeisung', sink=cFlow('P_el', bus=Strom, nominal_val=1000, costsPerFlowHour=p_feed_in)), Source('Stromtarif', source=cFlow('P_el', bus=Strom, nominal_val=1000, costsPerFlowHour={costs: p_sell, CO2: 0.3}))
