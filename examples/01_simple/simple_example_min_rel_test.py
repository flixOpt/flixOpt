...
aBoiler = cKessel('Boiler', eta = 0.5,costsPerRunningHour=1, # name, efficiency factor
                  ...
                  Q_th = cFlow(label = 'Q_th', # name of flow
                               ...
                               min_rel = [0.1,0.2,0.1,0.2,0.1,0.2,0.1,0.3,0.1], # 10 % minimum load, i.e. 5 kW
...
aSpeicher = cStorage('Speicher',
                     ...
                     chargeState0_inFlowHours=0.5 * 30, # empty storage at first time step
                     ...
                     min_rel_chargeState = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
                     )
