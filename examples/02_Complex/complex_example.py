...
if __name__ == '__main__':
    ...
    aKWK = fx.linear_converters.CHP(
        ...
        Q_fu=fx.Flow(
            ...
            bus=Gas,
            size=1e3,
            previous_flow_rate=20,  # The CHP was ON previously
        ),
    )
    ...
    segmented_conversion_factors = {  # Similar to eta_th, each factor here can be an array
        P_el: [(5, 30), (40, 60)],
        Q_th: [(6, 35), (45, 100)],
        Q_fu: [(12, 70), (90, 200)],
    }
    ...
    flow_system = fx.FlowSystem(time_series, last_time_step_hours=None)
    ...
    fig = fx.plotting.with_plotly(
        data=pd.DataFrame(Gaskessel.Q_th.model.flow_rate.result, index=used_time_series),
        mode='bar',
        show=True,
    )
