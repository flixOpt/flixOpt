...
class BaseModel:
    ...
    def registerPyComp(self, py_comp, aStr='', oldPyCompToOverwrite=None) -> None:
        ...
        if oldPyCompToOverwrite == None:
            self.countComp += 1
            # Komponenten einfach hochzählen, damit eindeutige Namen, data.h. a1_timesteps, a2, a3 ,...
            # Beispiel:
...
class Variable:
    def __init__(self, label: str, len: int, myMom, baseModel: BaseModel, isBinary: bool = False,
        ...
        myMom.element_model.variables.append(self)  # TODO: not nice, that this specific thing for energysystems is done here
...
class VariableTS(Variable):
    ...
    def transform2MathModel(self, baseModel:BaseModel) -> None:
