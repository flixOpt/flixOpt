...
class LinearConverter(Component):
    ...
    def __init__(self,
        ...
        self.conversion_factors = conversion_factors if conversion_factors is not None else []
        self.segmented_conversion_factors = segmented_conversion_factors if segmented_conversion_factors is not None else {}
